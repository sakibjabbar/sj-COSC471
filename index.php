...
<html lang="en">
  <head>
    ...
    <title>Ypsilanti Rental Application</title>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-heading">Ypsilanti Rentals<br></div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Search Units</h2>
          </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" id="keywords" name="keywords" type="text" placeholder="Keywords (Ex: 1bd, rent..)" required data-validation-required-message="Please enter keywords">
